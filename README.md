...
To get started:
 ...
 - Run `./rename_mlage_app my_new_app_name` to rename the 'mlage' app (and all references to it)
...
Create a Google App Engine project. Edit `app.yaml` and change `application: djangae-mlage` to `application: your-app-id`. Then, if you're in the `djangae-mlage` directory, run:
